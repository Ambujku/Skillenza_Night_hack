# -*- coding: utf-8 -*-
"""
Created on Sun Dec  8 04:50:01 2019
...
speech_key = "4f1dfaaaaf5f49c984b35bbdcbe2e4be"


# Function for Converting Speech to Text (Using AZURE)
...
Model = embedding_compressor_model

# Testing
Img_vec = Model.predict(speech_2_text())

img = Image.fromarray(Img_vec, 'RGB')
img.save('my.png')
img.show()
